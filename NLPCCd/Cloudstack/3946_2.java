//,temp,sample_3561.java,2,6,temp,sample_6360.java,2,6
//,2
public class xxx {
...
log.info("vcenter api trace createblankvm target mor vmname cpucount cpuspeedmhz cpureservedmhz limitcpu memorymb guestos datastore snapshotdirtoparent controllerinfo systemvm");
}
