...
log.info("attempted to create saxon xpathfactory by creating a new instance of failed will fallback and create xpathfactory using jdk api this exception is ignored stacktrace in debug logging level");
}
}
}
